...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="/voyager/datasets/st_data/htanpdac/tifs/proctifs",
    )
    parser.add_argument(
        "--save_dir",
        type=str,
    ...
    # python create_patches_fp.py --source /voyager/datasets/st_data/pdac2018/pdacwsis --save_dir /voyager/datasets/st_data/pdac2018/pdacslides --patch_size 256 --seg --patch --stitch

    # python create_patches_fp.py --source /voyager/datasets/st_data/pdac2018/gseslides --save_dir /voyager/datasets/st_data/pdac2018/pdacslides --patch_size 256 --seg --patch --stitch
